...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | Edson - Wedding Invitation</title>
    ...
    <!-- App css -->
    <link href="{{ url('assets/dashboard/assets/css/app.min.css') }}" rel="stylesheet" type="text/css" id="app-style"/>
    <!-- icons -->
    <link href="{{ url('assets/dashboard/assets/css/icons.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- Head js -->
    <script src="{{ url('assets/dashboard/assets/js/head.js') }}"></script>
    <style>
        ...
        <div class="container-fluid">
            <ul class="list-unstyled topnav-menu float-end mb-0">
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="{{ url('assets/dashboard/assets/images/users/user-1.jpg') }}" alt="user-image" class="rounded-circle">
            ...
            <div class="logo-box">
                <a href="index.html" class="logo logo-dark text-center">
                            <span class="logo-sm">
                                <img src="assets/dashboard/assets/images/logo-sm.png" alt="" height="22">
                                <!-- <span class="logo-lg-text-light">UBold</span> -->
                            </span>
                    <span class="logo-lg">
                                <img src="assets/dashboard/assets/images/logo-dark.png" alt="" height="20">
                ...
                <a href="index.html" class="logo logo-light text-center">
                    ...
                    <span class="logo-lg">
                                <img src="assets/dashboard/assets/images/logo-light.png" alt="" height="20">
                            </span>
                </a>
            </div>
    ...
    <div class="left-side-menu">
        ...
        <div class="h-100" data-simplebar>
            ...
            <div class="user-box text-center">
                <img src="{{ url('assets/dashboard/assets/images/users/user-1.jpg') }}" alt="user-img" title="Mat Helme"
    ...
    <div class="content-page">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <script>document.write(new Date().getFullYear())</script> &copy; Email Blaster by <a href="">IDS</a>
                    </div>
                    <div class="col-md-6">
...
<!-- Vendor js -->
<script src="{{ url('assets/dashboard/assets/js/vendor.min.js') }}"></script>

<!-- App js -->
<script src="{{ url('assets/dashboard/assets/js/app.min.js') }}"></script>
@yield('js')
